...
<div class="container bg-white">
  ...
  <h4>Phase 1</h4>
    <form action="phase1.php" method="POST">
      ...
      <table  class="table mt-1 table-condensed text-center">
        <thead> 
          <tr>
        ...
        <tbody>
          <tr>
            ...
            <td><input type="tel" name="recomputed_final_grade1" pattern="[0-9]{2}" title="Please input 2 Numbers only"></td>
            <td><input type="text" name="remedial_remarks1" id=""> </td>
          </tr>
          <tr>
            <td><input type="text" class="learning_areas2" name="learning_areas2"></td>
            <td><input type="tel" class="final_rating2" name="final_rating2"></td>
            <td><input type="text" name="remedial_class_mark2" id=""> </td>
            <td><input type="tel" name="recomputed_final_grade2" pattern="[0-9]{2}" title="Please input 2 Numbers only"></td>
